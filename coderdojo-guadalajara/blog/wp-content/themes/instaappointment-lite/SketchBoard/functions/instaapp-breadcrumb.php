...
class instaapp_breadcrumb_class {
    ...
    function custom_breadcrumb() {
        ...
        echo '<section class="cont_nav"><div class="cont_nav_inner"><p><a href="' . esc_url(home_url('/')) . '/">' . __('Home', 'instaapp') . '</a>';
    ...
    function simple_breadcrumb_case($der_post) {
        ...
        if (is_author()) {
            ...
            return __('Author', 'instaapp') . ' : ' . $curauth->display_name;
        ...
        if (is_tag()) {
            ...
            return __('Tag', 'instaapp') . ' : ' . single_tag_title('', false);
        ...
        if (is_search()) {
            ...
            return __('Search', 'instaapp');

        }

		if (is_404()) {            return __('Error 404', 'instaapp');        }
